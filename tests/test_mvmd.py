...
sys.path.append(os.path.abspath(os.path.join(os.getcwd(), '..', '..', 'src', 'mvmd')))
from mvmv_original import mvmd as mvmd_origins
from mvmv_optimized import mvmd as mvmd_opt
